% =========================================================================
% run_gesture_analysis_boundary_track_v3_2.m
...
PARA.gvi_threshold     = 4;     % GVI触发阈值 (dB): 全局波动能量超过此值，系统才进入"追踪模式"
...
% [关键抗干扰参数]
ALG.zenith_safe_deg    = 25;    % 安全仰角门限 (度): 用于剔除容易受身体遮挡的低仰角区域 (保留仰角 > 25° 的卫星)
