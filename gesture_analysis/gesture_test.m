...
run_gesture_analysis_continuous_track(obs_aligned, nav_data, step1_res_shaped);
run_gesture_analysis_continuous_track_line(obs_aligned, nav_data, step1_res_shaped);
run_gesture_analysis_boundary_trackV3(obs_aligned, nav_data, step1_res_shaped);
