% =========================================================================
% visualize_sensing_range_v2.m
% 功能: 可视化手势平面的个体感知范围与整体整合包络 (美化版)
% 风格: 现代科研风格，柔和配色
% 核心逻辑:
%   1. 寻找卫星最多的最佳时刻。
...
fprintf('--> 启动感知范围可视化 (Aesthetic Mode)...\n');

% --- 投影与感知参数 ---
TRAJ.gesture_height    = 0.20;  % 手势平面高度 (米)
TRAJ.min_elevation     = 25;    % 最低仰角过滤 (度)
TRAJ.sensing_radius    = 0.08;  % 个体感知半径 (米)
...
%% 4. 绘图 (Custom Aesthetics)
fprintf('--> [绘图] 生成最终可视化...\n');
f = figure('Name', 'Sensing Range Analysis v2.1', 'Position', [400, 150, 750, 750], 'Color', 'w');
...
title_str = {
    ...
    sprintf('\\rm\\fontsize{10}Height: %.2fm | Time: %s', TRAJ.gesture_height, datestr(obs_data(best_epoch_idx).time, 'HH:MM:SS')),
