...
% [关键抗干扰参数]
ALG.zenith_safe_deg    = 30;    % 安全仰角门限 (度): 用于剔除容易受身体遮挡的低仰角区域
ALG.top_k_percent      = 0.4;   % 前沿追踪比例 (0.2=20%): 仅利用距离圆心最远的20%的卫星点来计算重心(模拟指尖位置，抗手臂干扰)
TRAJ.time_cluster_k    = 10;     % 时域聚类窗口 (点数): 每5个采样点合并计算一个轨迹坐标(降低轨迹抖动)
